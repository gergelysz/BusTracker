...
public class TrackActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         *   If location accessing permission is granted,
         *   show current location with marker.
         */

//        if(mLocationPermissionGranted) {
//            getLocation();
//            LatLng currentLocationLatLng = new LatLng(Double.parseDouble(latitude), Double.parseDouble(longitude));
